...
class DeliveryTest {
    ...
    void shouldSuccessfulPlanMeeting() {
        ...
        SelenideElement selenideElement = $("[data-test-id='city'] input").setValue(validUser.getCity());
        $("[data-test-id='date'] input").sendKeys(Keys.chord(Keys.SHIFT, Keys.HOME), Keys.BACK_SPACE);
        $("[data-test-id='date'] input").setValue(firstMeetingDate);
        $("[data-test-id='name'] input").setValue("Александрова Лариса");
        $("[data-test-id='phone'] input").setValue("+79640000000");
